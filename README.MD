...
![最后更新](https://img.shields.io/badge/Latest-2026--03--09-green?logo=github)
...
该仓库是基于[packyan](https://github.com/packyan/NJUST_Master_Thesis_Latex_Template)版本的南京理工大学硕博士论文LaTeX模板。本项目对原仓库进行重构，兼容性修正。

## 特点

- 友好的指引文档
- 支持 Texlive 2025
- 符合 [GBT-7714 2015](https://github.com/zepinglee/gbt7714-bibtex-style) 标准的参考文献格式
...
| 日期 | 版本 |更新内容 |
|------|----------|----------|
| 2026-03-09 |v0.3| 修改页面样式 |
| 2026-03-09 |v0.2| 完善绪论 |
| 2025-10-23 |v0.1| 初版模版 |

## 后言

在完成本模板v0.1后，本人尝试联系学校
信息化部，发布后让大家一起完善，可以在
学校公众号的师生服务平台看到，但校方以
无法确定仓库是否安全为由拒绝了。
