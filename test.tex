...
\section{简介}
这是一个简单的 LaTeX \cite{newspaper2021energy}测试文档。

测试不同的引用格式：
\begin{itemize}
    \item 数字引用：\cite{newspaper2021energy}
    \item 括号引用：\citep{newspaper2021energy}
    \item 文本内引用：\citet{newspaper2021energy}
    \item 多个引用：\cite{newspaper2021energy,knuth1984tex}
\end{itemize}
